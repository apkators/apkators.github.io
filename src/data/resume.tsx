...
export const DATA = {
  name: "Shahzaib Ali",
  initials: "SA",
  url: "https://abdullahminhas.io",
  location: "Southampton, UK",
  locationLink: "https://www.google.com/maps/place/sanfrancisco",
  description:
    "App Reverse Engineer | Frida | MITM | Jadx | Ghidra | IDA PRO | R&D | Penetration Testing | Ethical Hacking | Postman | Android Studio | Java | Python",
  summary:
    "ZZ Technologies Islamabad focuses on Android app reverse engineering, utilizing tools like Frida and Jadx for dynamic and static analysis. The team conducts smali code debugging, emphasizing ethical hacking to address security challenges in mobile applications. A Computer Science graduate from the University of the Punjab, their academic foundation supports expertise in Android development and reverse engineering. They remain committed to innovation and robust app security, ensuring impactful contributions to the field.",
  avatarUrl: "./me.png",
  skills: [
    "Reverse Engineering:",
    "Ethical Hacking",
  ...
  contact: {
    email: "shahzaibpkofficial@gmail.com",
    tel: "+92 340 5053753",
    social: {
      GitHub: {
        name: "GitHub",
        url: "https://github.com/abdullahminhas",
        icon: Icons.github,
        navbar: true,
      },
      LinkedIn: {
        name: "LinkedIn",
        url: "https://www.linkedin.com/in/abdullahminhas/",
        icon: Icons.linkedin,
        navbar: true,
      },
      X: {
        name: "X",
        url: "https://x.com/mabdullahminhas",
        icon: Icons.x,
        navbar: false,
      },
      Youtube: {
        name: "Youtube",
        url: "https://www.youtube.com/@abdullahminhas7826",
        icon: Icons.youtube,
        navbar: false,
      },
      email: {
        name: "Send Email",
        url: "mailto:aminhas1996@gmail.com",
        icon: Icons.email,
        navbar: true,
      },
    },
  ...
  work: [
    {
      company: "ZZ Technologies",
      href: "https://dsstech.com.pk/",
      badges: [],
      ...
      description:
        "Reverse Engineered 40+ Android Apps Extracted APIs i.e. Tiktok, SnackVideo, Snapchat, Youtube, Whatsapp, LinkedIn and many more Private Algorithm implementation hidden in Android Apps Encryption/Decryption Implementation using Code Python Scripting Grip on Tools like Apktool, Jadx, Burpsuite, IDA Pro, Ghidra, Postman",
    },
    {
      company: "Keswa Techsol",
      badges: [],
      href: "https://buzzwaretech.com/",
      location: "Islamabad, PK",
      ...
      description:
        "2+ Years of Experience in Android Apps Development REST APIs implementation Latest Design Architecture Implementation Flask APIs development Firebase Implementation",
    },
    // {
    //   company: "Mitre Media",
  ...
  certifications: [
    {
      school: "Udemy",
      href: "https://www.udemy.com/certificate/UC-c29d87ca-0b3f-4427-b4ca-c3a2de360d2b/",
    ...
    {
      school: "Udemy",
      href: "https://www.udemy.com/certificate/UC-03ef238f-4990-48fa-9d0a-a7d3433cf9ec/",
